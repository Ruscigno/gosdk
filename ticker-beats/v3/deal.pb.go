...
type Deal struct {
	...
	DealType      DealType  `protobuf:"varint,8,opt,name=deal_type,json=dealType,proto3,enum=tickerbeats.v3.DealType" json:"deal_type,omitempty"`
	Entry         DealEntry `protobuf:"varint,9,opt,name=entry,proto3,enum=tickerbeats.v3.DealEntry" json:"entry,omitempty"`
...
var file_deal_proto_rawDesc = []byte{
	...
	0x63, 0x6b, 0x65, 0x72, 0x62, 0x65, 0x61, 0x74, 0x73, 0x2e, 0x76, 0x33, 0x22, 0xa1, 0x05, 0x0a,
...
var file_deal_proto_goTypes = []interface{}{
	(DealType)(0),   // 0: tickerbeats.v3.DealType
	(DealEntry)(0),  // 1: tickerbeats.v3.DealEntry
	(DealReason)(0), // 2: tickerbeats.v3.DealReason
	(*Deal)(nil),    // 3: tickerbeats.v3.Deal
}
var file_deal_proto_depIdxs = []int32{
	0, // 0: tickerbeats.v3.Deal.deal_type:type_name -> tickerbeats.v3.DealType
	1, // 1: tickerbeats.v3.Deal.entry:type_name -> tickerbeats.v3.DealEntry
