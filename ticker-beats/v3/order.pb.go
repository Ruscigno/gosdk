...
type Order struct {
	...
	OrderType      OrderType        `protobuf:"varint,6,opt,name=order_type,json=orderType,proto3,enum=tickerbeats.v3.OrderType" json:"order_type,omitempty"`
	State          OrderState       `protobuf:"varint,7,opt,name=state,proto3,enum=tickerbeats.v3.OrderState" json:"state,omitempty"`
	...
	TypeFilling    OrderFillingType `protobuf:"varint,10,opt,name=type_filling,json=typeFilling,proto3,enum=tickerbeats.v3.OrderFillingType" json:"type_filling,omitempty"`
	TypeTime       OrderTypeTime    `protobuf:"varint,11,opt,name=type_time,json=typeTime,proto3,enum=tickerbeats.v3.OrderTypeTime" json:"type_time,omitempty"`
...
var file_order_proto_rawDesc = []byte{
	...
	0x69, 0x63, 0x6b, 0x65, 0x72, 0x62, 0x65, 0x61, 0x74, 0x73, 0x2e, 0x76, 0x33, 0x22, 0xde, 0x08,
	...
	0x74, 0x73, 0x2e, 0x76, 0x33, 0x2e, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x54, 0x79, 0x70, 0x65, 0x52,
	...
	0x72, 0x62, 0x65, 0x61, 0x74, 0x73, 0x2e, 0x76, 0x33, 0x2e, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x46,
...
var file_order_proto_depIdxs = []int32{
	0, // 0: tickerbeats.v3.Order.order_type:type_name -> tickerbeats.v3.OrderType
	1, // 1: tickerbeats.v3.Order.state:type_name -> tickerbeats.v3.OrderState
	2, // 2: tickerbeats.v3.Order.type_filling:type_name -> tickerbeats.v3.OrderFillingType
	3, // 3: tickerbeats.v3.Order.type_time:type_name -> tickerbeats.v3.OrderTypeTime
	4, // 4: tickerbeats.v3.Order.reason:type_name -> tickerbeats.v3.OrderReason
