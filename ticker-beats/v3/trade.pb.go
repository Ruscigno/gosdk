...
type TradeTransaction struct {
	...
	Symbol          string                 `protobuf:"bytes,4,opt,name=symbol,proto3" json:"symbol,omitempty"`                                                                               // Trade symbol name
	TradeType       TradeTransactionType   `protobuf:"varint,5,opt,name=trade_type,json=tradeType,proto3,enum=tickerbeats.v3.TradeTransactionType" json:"trade_type,omitempty"`              // Trade transaction type
	OrderType       OrderType              `protobuf:"varint,6,opt,name=order_type,json=orderType,proto3,enum=tickerbeats.v3.OrderType" json:"order_type,omitempty"`                         // Order type
	OrderState      OrderState             `protobuf:"varint,7,opt,name=order_state,json=orderState,proto3,enum=tickerbeats.v3.OrderState" json:"order_state,omitempty"`                     // Order state
	TransactionType TransactionType        `protobuf:"varint,8,opt,name=transaction_type,json=transactionType,proto3,enum=tickerbeats.v3.TransactionType" json:"transaction_type,omitempty"` // Transaction type
	TimeType        OrderTypeTime          `protobuf:"varint,9,opt,name=time_type,json=timeType,proto3,enum=tickerbeats.v3.OrderTypeTime" json:"time_type,omitempty"`                        // Order type by action period
	TimeExpiration  *timestamppb.Timestamp `protobuf:"bytes,10,opt,name=time_expiration,json=timeExpiration,proto3" json:"time_expiration,omitempty"`                                        // Order expiration time
	Price           float64                `protobuf:"fixed64,11,opt,name=price,proto3" json:"price,omitempty"`                                                                              // Price
	PriceTrigger    float64                `protobuf:"fixed64,12,opt,name=price_trigger,json=priceTrigger,proto3" json:"price_trigger,omitempty"`                                            // Stop limit order activation price
	PriceStopLoss   float64                `protobuf:"fixed64,13,opt,name=price_stop_loss,json=priceStopLoss,proto3" json:"price_stop_loss,omitempty"`                                       // Stop Loss level
	PriceTakeProfit float64                `protobuf:"fixed64,14,opt,name=price_take_profit,json=priceTakeProfit,proto3" json:"price_take_profit,omitempty"`                                 // Take Profit level
	Volume          float64                `protobuf:"fixed64,15,opt,name=volume,proto3" json:"volume,omitempty"`                                                                            // Volume in lots
	PositionId      int64                  `protobuf:"varint,16,opt,name=position_id,json=positionId,proto3" json:"position_id,omitempty"`                                                   // Position ticket
...
func (x *TradeTransaction) GetDeletedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.DeletedAt
	}
	return nil
...
type TradeRequest struct {
	...
	AccountId      int64                  `protobuf:"varint,1,opt,name=account_id,json=accountId,proto3" json:"account_id,omitempty"`                                             // Account ID
	OrderId        int64                  `protobuf:"varint,2,opt,name=order_id,json=orderId,proto3" json:"order_id,omitempty"`                                                   // Order ticket
	Action         TradeRequestActions    `protobuf:"varint,3,opt,name=action,proto3,enum=tickerbeats.v3.TradeRequestActions" json:"action,omitempty"`                            // Trade operation type
	Magic          int64                  `protobuf:"varint,4,opt,name=magic,proto3" json:"magic,omitempty"`                                                                      // Expert Advisor ID (magic number)
	Symbol         string                 `protobuf:"bytes,5,opt,name=symbol,proto3" json:"symbol,omitempty"`                                                                     // Trade symbol
	Volume         float64                `protobuf:"fixed64,6,opt,name=volume,proto3" json:"volume,omitempty"`                                                                   // Requested volume for a transaction in lots
	Price          float64                `protobuf:"fixed64,7,opt,name=price,proto3" json:"price,omitempty"`                                                                     // Price
	StopLimit      float64                `protobuf:"fixed64,8,opt,name=stop_limit,json=stopLimit,proto3" json:"stop_limit,omitempty"`                                            // Stop Limit level of the order
	StopLoss       float64                `protobuf:"fixed64,9,opt,name=stop_loss,json=stopLoss,proto3" json:"stop_loss,omitempty"`                                               // Stop Loss level of the order
	TakeProfit     float64                `protobuf:"fixed64,10,opt,name=take_profit,json=takeProfit,proto3" json:"take_profit,omitempty"`                                        // Take Profit level of the order
	Deviation      int64                  `protobuf:"varint,11,opt,name=deviation,proto3" json:"deviation,omitempty"`                                                             // The maximal price deviation, specified in points, pip, cent, etc.
	OrderType      OrderType              `protobuf:"varint,12,opt,name=order_type,json=orderType,proto3,enum=tickerbeats.v3.OrderType" json:"order_type,omitempty"`              // Order type
	TypeFilling    OrderFillingType       `protobuf:"varint,13,opt,name=type_filling,json=typeFilling,proto3,enum=tickerbeats.v3.OrderFillingType" json:"type_filling,omitempty"` // Order execution type
	TypeTime       OrderTypeTime          `protobuf:"varint,14,opt,name=type_time,json=typeTime,proto3,enum=tickerbeats.v3.OrderTypeTime" json:"type_time,omitempty"`             // Order expiration type
	TimeExpiration *timestamppb.Timestamp `protobuf:"bytes,15,opt,name=time_expiration,json=timeExpiration,proto3" json:"time_expiration,omitempty"`                              // Order expiration time (for the orders of ORDER_TIME_SPECIFIED type)
	Comment        string                 `protobuf:"bytes,16,opt,name=comment,proto3" json:"comment,omitempty"`                                                                  // Order comment
	PositionId     int64                  `protobuf:"varint,17,opt,name=position_id,json=positionId,proto3" json:"position_id,omitempty"`                                         // TradeTransaction ticket
...
func (x *TradeRequest) GetDeletedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.DeletedAt
	}
	return nil
...
type TradeResult struct {
	...
	Retcode         uint32                 `protobuf:"varint,3,opt,name=retcode,proto3" json:"retcode,omitempty"`                                         // Operation return code
	TransactionId   int64                  `protobuf:"varint,4,opt,name=transaction_id,json=transactionId,proto3" json:"transaction_id,omitempty"`        // Transaction ticket, if it is performed
...
func (x *TradeResult) GetDeletedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.DeletedAt
	}
	return nil
...
var file_trade_proto_rawDesc = []byte{
	...
	,
	...
	0x2e, 0x76, 0x33, 0x2e, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x54,
	0x79, 0x70, 0x65, 0x52, 0x0f, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e,
	0x54, 0x79, 0x70, 0x65, 0x12, 0x3a, 0x0a, 0x09, 0x74, 0x69, 0x6d, 0x65, 0x5f, 0x74, 0x79, 0x70,
	0x65, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1d, 0x2e, 0x74, 0x69, 0x63, 0x6b, 0x65, 0x72,
	0x62, 0x65, 0x61, 0x74, 0x73, 0x2e, 0x76, 0x33, 0x2e, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x54, 0x79,
	...
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x14, 0x0a, 0x05, 0x70, 0x72, 0x69, 0x63, 0x65, 0x18, 0x0b,
	0x20, 0x01, 0x28, 0x01, 0x52, 0x05, 0x70, 0x72, 0x69, 0x63, 0x65, 0x12, 0x23, 0x0a, 0x0d, 0x70,
	0x72, 0x69, 0x63, 0x65, 0x5f, 0x74, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x18, 0x0c, 0x20, 0x01,
	...
	,
	...
	0xdc, 0x07, 0x0a, 0x0c, 0x54, 0x72, 0x61, 0x64, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	...
	0x03, 0x52, 0x07, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x49, 0x64, 0x12, 0x3b, 0x0a, 0x06, 0x61, 0x63,
	0x74, 0x69, 0x6f, 0x6e, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x23, 0x2e, 0x74, 0x69, 0x63,
	0x6b, 0x65, 0x72, 0x62, 0x65, 0x61, 0x74, 0x73, 0x2e, 0x76, 0x33, 0x2e, 0x54, 0x72, 0x61, 0x64,
	0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x52,
	0x06, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x14, 0x0a, 0x05, 0x6d, 0x61, 0x67, 0x69, 0x63,
	0x18, 0x04, 0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x6d, 0x61, 0x67, 0x69, 0x63, 0x12, 0x16, 0x0a,
	...
	,
	...
	0x61, 0x6d, 0x70, 0x52, 0x09, 0x64, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x64, 0x41, 0x74, 0x22, 0xef,
	0x03, 0x0a, 0x0b, 0x54, 0x72, 0x61, 0x64, 0x65, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x12, 0x1d,
	...
	0x07, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x49, 0x64, 0x12, 0x18, 0x0a, 0x07, 0x72, 0x65, 0x74, 0x63,
	...
	0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x12, 0x16, 0x0a, 0x06, 0x76, 0x6f, 0x6c,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x53, 0x54, 0x10, 0x0a, 0x42, 0x11, 0x5a, 0x0f, 0x74, 0x69, 0x63, 0x6b, 0x65, 0x72, 0x2d, 0x62,
	0x65, 0x61, 0x74, 0x73, 0x2f, 0x76, 0x33, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_trade_proto_goTypes = []interface{}{
	...
	(OrderFillingType)(0),         // 11: tickerbeats.v3.OrderFillingType
	(TransactionReason)(0),        // 12: tickerbeats.v3.TransactionReason
...
var file_trade_proto_depIdxs = []int32{
	...
	10, // 6: tickerbeats.v3.TradeTransaction.created_at:type_name -> google.protobuf.Timestamp
	10, // 7: tickerbeats.v3.TradeTransaction.updated_at:type_name -> google.protobuf.Timestamp
	10, // 8: tickerbeats.v3.TradeTransaction.deleted_at:type_name -> google.protobuf.Timestamp
	...
	11, // 11: tickerbeats.v3.TradeRequest.type_filling:type_name -> tickerbeats.v3.OrderFillingType
	...
	12, // 14: tickerbeats.v3.TradeRequest.reason:type_name -> tickerbeats.v3.TransactionReason
	...
	10, // 18: tickerbeats.v3.TradeRequest.deleted_at:type_name -> google.protobuf.Timestamp
	10, // 19: tickerbeats.v3.TradeResult.created_at:type_name -> google.protobuf.Timestamp
	10, // 20: tickerbeats.v3.TradeResult.updated_at:type_name -> google.protobuf.Timestamp
	10, // 21: tickerbeats.v3.TradeResult.deleted_at:type_name -> google.protobuf.Timestamp
